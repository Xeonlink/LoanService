...
<div align="center">
  <img src="publish/readme/favicon.png" alt="Logo" width="100"><br />
  <img src="publish/readme/title.png" alt="Logo" width="200">
</div>

# 📋 개요

<img src="publish/readme/overview.png" width="450" />
...
<img src="publish/readme/book_add.png" alt="도서를 추가하기 위해서 나오는 화면, 바코드 제목 저자 출판다 분류번호를 적어야 하며 각각의 적는 공간에는 지우기 버튼이 있다. 창의 하단에는 닫기 모두 지우기 추가하기 버튼이 있다." width="400" />
...
<img src="publish/readme/book_search.png" alt="도서를 검색할 수 있는 창" width="450">
...
<img src="publish/readme/book_update.png" alt="도서의 정보를 수정하기 위해서 나오는 화면, 도서를 추가하기 위해 나오는 화면, 도서를 추가하기 위한 화면과 구성이 동일하며 추가하기 버튼대신 수정하기 버튼이 동일한 위치에 있다."  width="400">
...
<img src="publish/readme/book_delete.png" alt="도서를 삭제하기 전 나오는 화면입니다. 도서삭제, 삭제되면 복구하기 어렵습니다. 정말로 삭제하시겠습니까? 라며 삭제를 경고하고 있습니다. 닫기 삭제 버튼이 있어 삭제를 취소하고 창을 닫거나, 삭제 버튼을 눌러 도서를 삭제하고 창을 닫을 수 있습니다." width="400">
...
<img src="publish/readme/member_add.png" alt="회원을 추가하기 위해 나타나는 화면, 도서 추가하기와 비슷한 구성의 창이 나타납니다. 회원의 이름 연락처 대출증을 발급했다면 대출코드를 입력해야합니다. 하단에는 닫기, 모두 지우기, 추가하기 버튼이 있습니다." width="400">
...
<img src="publish/readme/member_search.png" alt="도서를 검색할 수 있는 창" width="450">
...
<img src="publish/readme/member_update.png" alt="회원의 정보를 수정하기 위해서 나오는 화면, 회원을 추가하기 위해 나오는 화면, 회원를 추가하기 위한 화면과 구성이 동일하며 추가하기 버튼대신 수정하기 버튼이 동일한 위치에 있다." width="400">
...
<img src="publish/readme/member_delete.png" alt="회원을 삭제하기 전 나오는 화면입니다. 회원삭제, 이 회원의 이전 대출이력이 모두 삭제됩니다. 복구할 수 없습니다. 정말로 삭제하시겠습니까? 라며 삭제를 경고하고 있습니다. 닫기 삭제 버튼을 눌러 회원을 삭제하고 창을 닫을 수 있습니다." width="400">
...
<img src="publish/readme/loan0.png" alt="대출을 하기 위한 화면" width="450">
...
<img src="publish/readme/loan1.png" alt="대출을 하기 위한 화면" width="450">
